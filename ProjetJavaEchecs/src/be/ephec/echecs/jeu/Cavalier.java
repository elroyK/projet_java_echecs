...
public class Cavalier extends Piece {
	...
	public Position[] genererPos(Echiquier plateau) {
		...
		if (((this.pos.getX()+1)>7)||((this.pos.getY()+2)>7)) work[0]=null;
		else {
			work[0].setX(this.pos.getX()+1);
			work[0].setY(this.pos.getY()+2);
		}
		
		if (((this.pos.getX()+1)>7)||((this.pos.getY()-2)<0)) work[1]=null;
		else {
			work[1].setX(this.pos.getX()+1);
			work[1].setY(this.pos.getY()-2);
		}
		
		if (((this.pos.getX()+2)>7)||((this.pos.getY()+1)>7)) work[2]=null;
		else{		
			work[2].setX(this.pos.getX()+2);
			work[2].setY(this.pos.getY()+1);
		}
		
		if (((this.pos.getX()+2)>7)||((this.pos.getY()-1)<0)) work[3]=null;
		else {
			work[3].setX(this.pos.getX()+2);
			work[3].setY(this.pos.getY()-1);
		}
		
		if (((this.pos.getX()-1)<0)||((this.pos.getY()+2)>0)) work[3]=null;
		else {
