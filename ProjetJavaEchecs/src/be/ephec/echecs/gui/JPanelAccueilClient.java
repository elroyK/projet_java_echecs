...
import be.ephec.echecs.tcp.ApplicationClient;
...
public class JPanelAccueilClient extends JPanel {
	...
	public JPanelAccueilClient(final ApplicationClient applicationClient) {
		...
		JLabel lblNumroDePort = new JLabel("Numero de port :");
		...
		jTxtNumroDePort.setText(Param.NUMPORT+""); // le +"" permet de changer l'entier en chaîne de caractères
		...
		btnSeConnecterAu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					applicationClient.setClient(new MonClientTCP(applicationClient));
